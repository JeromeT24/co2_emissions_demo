...
table_df["Absolute Change"] = table_df["2000"] - table_df["2022"] 

# Calculate relative change as the absolute change divided by the 2000 emissions, then multiplied by 100
table_df["Relative Change"] = (table_df["Absolute Change"] / 2000) * 100
...
emissions_long_subset = emissions_long.query(
    "country in ['Afghanistan', 'Japan', 'Germany', 'Zimbabwe', 'Colombia']"
)
...
fig_chart = px.line(
    ...
    title="CO2 Emissions from 1990 to 2022 for Afghanistan, <br>Colombia, Germany, Japan, and Zimbabwe",
)

# Adjust layout to add space between title and plot
fig_chart.update_layout(
    title={
        "y": 0.95,  # Position title higher (default is 1.0)
